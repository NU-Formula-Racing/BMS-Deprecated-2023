...
void loop()
{
  ...
  bq.Comm(BQ79656::RequestType::STACK_WRITE, seriesPerSegment, 0, static_cast<BQ79656::RegisterAddress>(static_cast<uint16_t>(BQ79656::RegisterAddress::CB_CELL1_CTRL) + 1 - seriesPerSegment), balTimes);
