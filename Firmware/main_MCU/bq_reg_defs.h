...
#define CUST_MISC [0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28]
...
#define CB_CELL_CTRL [0x327, 0x326, 0x325, 0x324, 0x323, 0x322, 0x321, 0x320, 0x31F, 0x31E, 0x31D, 0x31C, 0x31B, 0x31A, 0x319, 0x318]
...
#define OTP_ECC_DATAIN [0x343, 0x344, 0x345, 0x346, 0x347, 0x348, 0x349, 0x34A, 0x34B]
...
#define OTP_ECC_DATAOUT [0x510, 0x511, 0x512, 0x513, 0x514, 0x515, 0x516, 0x517, 0x518]
...
#define FAULT_COMP_VBOW1 0x54B
#define FAULT_COMP_VBOW2 0x54C
